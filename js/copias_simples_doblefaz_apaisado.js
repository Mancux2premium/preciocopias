...
function calcular_precio_fotocopias() {
  let a = document.getElementById("a").value;
   ...
   let precioCopiasSimples = 20;
   let precioCompiasDobleFaz = 30;
   var precioCompiasApaisado = 30; 
   var cantidad_copias_default =1;
   var correcionPrecioPorHojaImparDoblefaz= 30;
   var correcionPrecionporHojaImparApaisado =30;
   var maximascopiasPermitidasaimprimir = 9000;
   var precioAnillado = 500;
