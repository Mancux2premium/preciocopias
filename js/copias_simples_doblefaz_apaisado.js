...
function calcular_precio_fotocopias() {
  let a = document.getElementById("a").value;
   ...
   let precioCopiasSimples = 50;
   let precioCompiasDobleFaz = 50;
   var precioCompiasApaisado = 50; 
   var cantidad_copias_default =1;
   var correcionPrecioPorHojaImparDoblefaz= 50;
   var correcionPrecionporHojaImparApaisado =50;
   var maximascopiasPermitidasaimprimir = 9000;
   var precioAnillado = 900;
